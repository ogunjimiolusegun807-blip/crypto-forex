        ...
        <AppBar position="fixed" color="primary" sx={{ zIndex: (theme) => theme.zIndex.drawer + 1, boxShadow: 3 }}>
          <Toolbar>
            ...
            <Box sx={{ display: 'flex', alignItems: 'center', mr: 2 }}>
              <img src="/ELONINVESTMENT-LOGO.jpg" alt="Elon Investment Logo" style={{ height: 38, maxWidth: 48, objectFit: 'contain', borderRadius: 4, boxShadow: '0 2px 8px rgba(0,0,0,0.10)', background: '#fff', marginRight: 12 }} />
